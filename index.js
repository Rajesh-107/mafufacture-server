...
async function run() {
  try {
    ...
    const reduxCollection = client.db("manufacture").collection("reduxproducts");
    ...
    app.post("/product", async (req, res) => {
      ...
      const result = await reduxCollection.insertOne(product);
    ...
    app.post("/order", async (req, res) => {
      ...
      const exists = orderCollection.findOne(query);
      if (exists) {
